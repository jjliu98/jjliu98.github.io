import{a as v}from"./axios-B6xwUs71.js";import{f as k,A as x,L as p,g,r as y,o as E,M as T,w as H,b as I}from"./app-_sW_HT98.js";import{_ as w}from"./plugin-vue_export-helper-DlAUqK2U.js";const B=I("div",{class:"none"},"一言插件",-1),C=k({__name:"HeroHitokoto",setup(M){let h="https://v1.hitokoto.cn";const _=e=>{const t=window;clearInterval(t.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const d=o[0];d.id="hotWord"}const m=document.getElementById("hotWord");if(!m)return;m.innerHTML=`
<div class="word">
  <div class="left">『</div>
